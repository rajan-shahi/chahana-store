...
export default function Glasses({ addToCart }) {
  ...
  const uniqueBrands = [...new Set(ProductData.categories.glasses.map((item) => item.brand))];
  const uniqueSizes = [
    ...new Set(ProductData.categories.glasses.flatMap((item) => item.variants.sizes)),
  ];
  const uniqueColors = [
    ...new Set(ProductData.categories.glasses.flatMap((item) => item.variants.colors)),
  ];
  const uniqueGenders = [
    ...new Set(ProductData.categories.glasses.map((item) => item.category.gender)),
  ];
  const uniqueUses = [
    ...new Set(ProductData.categories.glasses.flatMap((item) => item.category.use)),
  ];
  const uniqueAgeGroups = [
    ...new Set(ProductData.categories.glasses.map((item) => item.category.age_group)),
  ];
  ...
  const filteredProducts = ProductData.categories.glasses.filter((item) => {
    return (
